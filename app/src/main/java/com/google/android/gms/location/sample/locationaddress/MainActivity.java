                ...
                .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        ...
                        try {
                            ...
                            final ListView list = findViewById(R.id.list_mobile);
                            final MobileArrayAdapter listAdapter = new MobileArrayAdapter(getBaseContext(), addresses);
                            list.setAdapter(listAdapter);
                            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                @Override
                                public void onItemClick(AdapterView<?> parent, View view, int pos, long id) {
                                    System.out.println("!!!");
                                    Address selectedValue = listAdapter.getItem(pos);
                                    String toastStr = selectedValue.toString();
